namespace Cosmetics.Engine
{
    ...
    internal class CosmeticsEngine : IEngine
    {
        ...
        {
            switch (command.Name)//AddToCategory Formale
            {
                case "CreateCategory":
                ...
                case "AddToCategory":
                    var categoryNameToAdd = command.Parameters[0]; //ForMale
                    var productToAdd = command.Parameters[1];  //White+
